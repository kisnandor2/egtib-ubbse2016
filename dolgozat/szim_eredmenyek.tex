...
\begin{minipage}{\linewidth}
	...
	\begin{multicols}{2}
		...
		\end{Figure}
	\end{multicols}
	\captionof{figure}{A játék végkimenetele két diffúziós távolságra\label{fig:DiffDist}}
\end{minipage}\\


Megfigyelhető, hogy a távolság növekedésével a defektáló sejtek is könnyebben terjednek, 

\subsection{Osztódni képes populációk}
