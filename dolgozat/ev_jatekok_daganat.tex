...
A legtöbbet használt modell, mely elég közel áll a természethez, az a Gompertz modell, amely leírja a tumor méretének időbeli változását a következő képlettel:
\begin{equation}
